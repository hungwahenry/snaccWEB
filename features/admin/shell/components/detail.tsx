...
/** The dashed box a section shows when it has nothing to list. */
export function EmptyNote({ children }: { children: ReactNode }) {
  return (
    <p className="rounded-lg border border-dashed px-4 py-8 text-center text-sm text-pretty text-muted-foreground">
      {children}
    </p>
  )
}
