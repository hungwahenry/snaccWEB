...
export const NAV: { group: string; items: NavItem[] }[] = [
  {
    group: "Overview",
    items: [{ href: "/admin", label: "Dashboard", icon: LayoutDashboard, permission: "dashboard.read" }],
  },
  {
    group: "People",
    items: [{ href: "/admin/users", label: "Users", icon: Users, permission: "users.read" }],
  },
  {
    group: "Content",
    items: [
      { href: "/admin/snaccs", label: "Snaccs", icon: MessageSquare, permission: "snaccs.read" },
      { href: "/admin/reports", label: "Reports", icon: Flag, permission: "reports.read" },
      { href: "/admin/messages", label: "Messages", icon: Ghost, permission: "messages.read" },
      { href: "/admin/report-reasons", label: "Report reasons", icon: Tags, permission: "report_reasons.read" },
      { href: "/admin/suspension-reasons", label: "Suspension reasons", icon: UserX, permission: "users.read" },
      ...
      { href: "/admin/challenges", label: "Challenges", icon: Trophy, permission: "challenges.read" },
    ],
  },
  {
    group: "Money",
    items: [
      { href: "/admin/earnings", label: "Earnings", icon: Coins, permission: "earnings.read" },
      { href: "/admin/withdrawals", label: "Withdrawals", icon: Banknote, permission: "withdrawals.read" },
    ],
  },
  {
    group: "Platform",
